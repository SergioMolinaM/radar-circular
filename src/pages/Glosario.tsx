...
const terminos = [
  ...
  { sigla: 'OEC', nombre: 'Oficina de Economía Circular', definicion: 'Unidad del MMA responsable de la implementación de la Ley REP, coordinación de decretos y relación con SIG. Jefa actual: María José Ureta.' },
